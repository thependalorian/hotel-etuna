...
export const metadata: Metadata = {
  title: 'Rooms & Suites',
  description: 'Explore our 5 distinct room types at Hotel Etuna. From comfortable Standard Rooms to luxurious Premier Suites with private pools.',
};
...
const rooms = [
  {
    ...
    amenities: ['Queen Bed', 'AC', 'WiFi', 'Mosquito Net', 'En-suite Bathroom', 'TV'],
  },
  {
    name: 'Luxury Room',
    slug: 'luxury',
    ...
    amenities: ['King Bed', 'AC', 'Mini Bar', 'Bathtub', 'Work Desk', 'Balcony'],
  },
  {
    name: 'Family Suite',
    slug: 'family',
    ...
    capacity: 4,
    size: '48m²',
    description: 'Spacious suite ideal for families with separate bedrooms and living space.',
    amenities: ['2 Bedrooms', 'Living Room', 'Kitchenette', '2 Bathrooms', 'WiFi', 'TV'],
  },
  {
    ...
    capacity: 2,
    size: '42m²',
    description: 'Perfect for business travelers with dedicated workspace and lounge area.',
    amenities: ['King Bed', 'Work Desk', 'Lounge Area', 'Balcony', 'Coffee Machine', 'Safe'],
  },
  {
    name: 'Premier Suite',
    slug: 'premier',
    ...
    capacity: 2,
    size: '65m²',
    description: 'Our most luxurious offering with private pool and butler service.',
    amenities: ['Master Bedroom', 'Private Pool', 'Butler Service', 'Spa Bath', 'Dining Area', 'Premium Minibar'],
  },
];
