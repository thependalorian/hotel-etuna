 ...
 * 
 * Purpose: Public-facing homepage with Hero, Story, Rooms, Dining, Reviews, Booking, Partners
...
export const metadata: Metadata = {
  ...
  description: 'Welcome to Hotel Etuna in Ongwediva, Namibia. Experience authentic Namibian hospitality with 5 room types, on-site restaurant, and pool.',
};
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-terracotta-800 mb-8 leading-relaxed">
                ...
                authentic Namibian hospitality in the heart of Northern Namibia.
              </p>
              ...
              {[
                {
                  ...
                  amenities: ['WiFi', 'Air Conditioning', 'TV', 'Minibar', 'Mosquito Net'],
                },
                {
                  name: 'Luxury Room',
                  slug: 'luxury-room',
                  ...
                  amenities: ['WiFi', 'Air Conditioning', 'TV', 'Minibar', 'Bathrobe', 'Sitting Area'],
                },
                {
                  name: 'Family Room',
                  slug: 'family-room',
                  ...
                  amenities: ['WiFi', 'Air Conditioning', 'TV', 'Minibar', 'Extra Bedding', 'Garden Access'],
                },
                {
                  ...
                  amenities: ['WiFi', 'Air Conditioning', 'Work Desk', 'VIP Toiletries', 'Lounge Access'],
                },
                {
                  name: 'Premier Room',
                  slug: 'premier-room',
                  ...
                  amenities: ['WiFi', 'Private Balcony', 'Lounge', '2 Bathrooms', 'Bathrobe'],
                },
              ].map((room) => (
                <Link
                  key={room.slug}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-terracotta-800 mb-6 leading-relaxed">
                  ...
                  Start your day with our breakfast service, enjoy traditional dishes for lunch, and savor
                  expertly prepared dinners featuring signature dishes like slow-cooked oshifima with spinach,
                  fresh Zambezi bream, and hearty potjie.
                </p>
                <ul className="space-y-3 mb-8">
                  {[
                    'Breakfast (06:30 - 10:00)',
                    'Traditional Namibian specialties',
                    'Signature dishes: oshifima, Zambezi bream, potjie',
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  location: 'Germany',
                  rating: 5,
                  comment: 'A true gem in Ongwediva. Wonderful dining and the staff\'s warmth made us feel like family. Highly recommend!',
                },
              ].map((review) => (
        ...
        <section id="booking" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-linear-to-br from-khaki-600 to-terracotta-800 rounded-3xl p-8 md:p-12 text-white">
              ...
              <LandingBookingWidget propertyId={process.env.DEFAULT_PROPERTY_ID || ''} />
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  description: 'Beautifully furnished self-catering rooms. Ideal for business travellers, families, and groups.',
                  location: 'Windhoek',
                },
                {
                  ...
                  description: 'Budget-friendly homestay penthouse with one double room and private bathroom.',
                  location: 'Windhoek',
                },
              ].map((partner) => (
                <Link
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-white/80">5544 Valley Street, Ongwediva, Namibia</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Phone className="w-4 h-4 shrink-0" />
                    <div className="text-white/80">
                      <a href="tel:+26465231177" className="hover:text-khaki-600 transition-colors block">
                        +264 65 231 177
                      </a>
                      <a href="tel:+264818024833" className="hover:text-khaki-600 transition-colors block">
                        +264 81 802 4833
                      </a>
                    </div>
                  </li>
