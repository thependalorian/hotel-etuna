...
const NewPropertyPage = () => {
  return (
    <div className="etuna-page-stack max-w-3xl">
      ...
      <header className="etuna-hero-band relative p-6 md:p-8">
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex min-w-0 gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-khaki-600 text-white shadow-md md:h-14 md:w-14">
              <Building2 className="h-6 w-6 md:h-7 md:w-7" aria-hidden />
            </div>
            <div className="min-w-0">
              <p className="etuna-eyebrow mb-2 text-khaki-600">Property setup</p>
              <h2 className="etuna-page-title mb-2">Property details</h2>
              <p className="etuna-page-desc text-nude-700">
      ...
      <div className="rounded-2xl border border-nude-200 bg-surface-elevated p-6 shadow-card md:p-8">
        <PropertyForm />
      </div>
    </div>
  );
