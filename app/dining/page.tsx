      ...
      <main>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-12">
                <div className="bg-nude-50 rounded-xl p-6">
                  ...
                  <p className="text-sm text-terracotta-800">Ingredients sourced from local suppliers</p>
                </div>
                <div className="bg-nude-50 rounded-xl p-6">
                  <div className="w-12 h-12 bg-sage/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <p className="text-sm text-terracotta-800">Experienced culinary team with passion</p>
                </div>
                <div className="bg-nude-50 rounded-xl p-6">
                  <div className="w-12 h-12 bg-sage/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Clock className="w-6 h-6 text-sage" />
                  </div>
                  <h3 className="font-semibold text-terracotta-900 mb-2">Clear Hours</h3>
        ...
        <section className="py-16 bg-linear-to-br from-khaki-600 to-terracotta-800 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button asChild size="xl" className="bg-white text-terracotta-900 hover:bg-khaki-700 hover:text-white">
