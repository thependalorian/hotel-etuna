...
const PUBLIC_ROUTES = [
  ...
  // Note: /pricing, /features, /about, /contact pages do not exist yet
  // These routes are kept in middleware for future use but links removed from navigation
  ...
  '/public-properties', // Public property pages
];
