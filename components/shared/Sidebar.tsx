        ...
        <div className="flex items-center justify-between border-b border-nude-200 p-4 md:p-6">
          <Link href="/dashboard" className="group flex flex-1 items-center gap-3">
            <div className="relative">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-nude-500 to-luxury-charlotte opacity-25 blur-md transition-opacity group-hover:opacity-40" />
              <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-nude-600 to-nude-500 text-lg font-bold text-white shadow-nude-primary transition-transform duration-normal group-hover:scale-105">
                H
              </div>
            </div>
            <div>
              <div className="font-display text-xl font-bold text-nude-900">Buffr Host</div>
              <div className="text-xs font-medium text-nude-600">Hospitality OS</div>
            </div>
          </Link>
          <button
            type="button"
