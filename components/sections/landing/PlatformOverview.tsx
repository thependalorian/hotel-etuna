      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-base-content/90 max-w-2xl mx-auto">
            Unlike phone-only solutions, Buffr Host provides everything you need in one integrated platform. No external PMS required. No fragmented systems. Everything works together seamlessly.
          </p>
        </div>
