  ...
  if (guests.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-nude-600 font-medium">No guests found</p>
      </div>
    );
  }
      ...
      <table className="w-full min-w-[640px] sm:min-w-0">
        <thead>
          <tr className="border-b-2 border-nude-200">
            <th className="text-left py-3 px-4 text-sm font-semibold text-nude-700">Guest</th>
            <th className="text-left py-3 px-4 text-sm font-semibold text-nude-700">Contact</th>
            <th className="text-left py-3 px-4 text-sm font-semibold text-nude-700">Stats</th>
            <th className="text-right py-3 px-4 text-sm font-semibold text-nude-700">Actions</th>
          </tr>
        </thead>
        <tbody>
            ...
            >
              <td className="py-4 px-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-nude-500 mt-0.5">Guest ID: {guest.id.slice(0, 8)}</p>
                  </div>
                </div>
              </td>
              <td className="py-4 px-4">
              ...
              <td className="py-4 px-4">
                <div className="flex gap-2">
                  <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-nude-100 text-nude-700">
                    0 visits
                  </span>
                  <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-nude-100 text-nude-700">
                    N$0
