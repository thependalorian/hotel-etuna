...
export default function ReviewsTable({ reviews, properties, selectedPropertyId, onPropertyChange }: ReviewsTableProps) {
  return (
    <div>
          ...
          <table className="table w-full min-w-[640px] sm:min-w-0">
            ...
            <tbody>
              {reviews.map((review, index) => (
                ...
                >
                  <td className="font-medium">{review.guest_id.slice(0, 8)}...</td>
                  <td>
