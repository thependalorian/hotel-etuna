...
export class EmailTemplateService {
  ...
  generateVerificationEmail(options: EmailTemplateOptions) {
    ...
    const body = `Welcome to Buffr Host, ${firstName}!
...
If you didn't create this account, please ignore this email.`;
    ...
    return {
      subject: 'Verify Your Buffr Host Account - Welcome from Sofia!',
      html: this.templateGenerator.generateHtmlTemplate({
        subject: 'Verify Your Buffr Host Account',
        body,
      }),
...
You requested to reset your password for your Buffr Host account. Click the button below to create a new password:
...
Need help getting started? Our support team is here for you.`;
    ...
    return {
      subject: 'Welcome to Buffr Host - Your Account is Ready!',
      html: this.templateGenerator.generateHtmlTemplate({
        subject: 'Welcome to Buffr Host',
        body,
        ctaLink: `${process.env.NEXTAUTH_URL || 'https://host.buffr.ai'}/dashboard`,
...
We detected ${alertType} on your Buffr Host account at ${timestamp}.
...
If this was you, you can safely ignore this email.`;
    ...
    return {
      ...
      html: this.templateGenerator.generateHtmlTemplate({
        ...
        body,
        ctaLink: `${process.env.NEXTAUTH_URL || 'https://host.buffr.ai'}/settings`,
...
You've been invited to join ${propertyName} on Buffr Host as a staff member.
...
Click the button below to accept the invitation and create your account.`;
    ...
    return {
      subject: `You've Been Invited to Join ${options.propertyName || 'Buffr Host'}`,
      html: this.templateGenerator.generateHtmlTemplate({
...
${options.ctaLink ? 'Click below for more details:' : ''}`;
    ...
    return {
      subject: options.subject || 'Important Notification from Buffr Host',
      html: this.templateGenerator.generateHtmlTemplate({
...
You requested a new verification code for your Buffr Host account. Please use the following code to verify your email address:
...
If you didn't request this code, please ignore this email.`;
    ...
    return {
      subject: 'Verify Your Buffr Host Account - New Code',
      html: this.templateGenerator.generateHtmlTemplate({
        subject: 'Verify Your Buffr Host Account',
        body,
      }),
