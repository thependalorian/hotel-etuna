  ...
  return withApiAuth(
    ...
    async (req, user) => {
      ...
      if (type === 'category') {
        ...
        const newCategory = await menuService.createMenuCategory(user.tenantId, restaurantId, validatedData.data);
        ...
        const newItem = await menuService.createMenuItem(user.tenantId, propertyId, validatedData.data);
