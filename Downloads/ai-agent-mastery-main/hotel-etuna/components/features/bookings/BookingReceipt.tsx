    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white border-2 border-gray-300 rounded-lg p-8 print:border-0">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-1">PAYMENT RECEIPT</h2>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
          <div>
            <p className="text-gray-600 font-medium mb-1">Booking Reference:</p>
            <p className="text-gray-900 font-semibold">{booking.bookingReference}</p>
          </div>
          <div>
            <p className="text-gray-600 font-medium mb-1">Payment Method:</p>
            <p className="text-gray-900 font-semibold capitalize">{booking.paymentMethod}</p>
          </div>
          <div>
            <p className="text-gray-600 font-medium mb-1">Check-In:</p>
            <p className="text-gray-900">{formatDate(booking.checkInDate)}</p>
          </div>
          <div>
            <p className="text-gray-600 font-medium mb-1">Check-Out:</p>
        ...
        <div className="border-t border-gray-200 pt-4 mb-6">
          <h3 className="text-sm font-bold text-gray-700 mb-3">GUEST INFORMATION</h3>
        ...
        {rooms.length > 0 && (
          <div className="border-t border-gray-200 pt-4 mb-6">
            <h3 className="text-sm font-bold text-gray-700 mb-3">ROOM DETAILS</h3>
        ...
        <div className="border-t-2 border-gray-300 pt-4 mb-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between pt-2 border-t border-gray-200">
              <span className="text-gray-700 font-bold">Change Given:</span>
        ...
        <div className="mt-8 pt-6 border-t border-gray-300 print:block hidden">
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-xs text-gray-600 text-center">Staff Signature</p>
            </div>
            <div>
              <div className="border-b border-gray-400 mb-2 h-8"></div>
